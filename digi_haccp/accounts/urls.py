...
urlpatterns = [
    ...
    path('invite-user-to-deli/', views.invite_user_to_deli_view, name='invite_user_to_deli'),
    path('join-request/<int:request_id>/<str:action>/', views.respond_deli_join_request, name='respond_deli_join_request'),
